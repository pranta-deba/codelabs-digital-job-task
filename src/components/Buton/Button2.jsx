...
const Button2 = ({ text = 'text' }) => {
    return (
        <button className="btn bg-[#FFC637]  hover:bg-transparent rounded-[12px]  text-base font-medium text-[#020043] flex items-center gap-2">{text}<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
